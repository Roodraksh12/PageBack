    ...
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-md max-h-[95vh] overflow-y-auto bg-cream-50 dark:bg-forest-900 flex flex-col rounded-3xl shadow-warm border border-cream-200 dark:border-forest-700 animate-fade-in">
        ...
        <div className="p-8">
          ...
          {/* Social Auth (UI Only) */}
          <button className="w-full flex items-center justify-center gap-3 bg-white dark:bg-forest-800 border border-cream-200 dark:border-forest-600 rounded-xl px-4 py-3 text-sm font-medium text-forest-800 dark:text-cream-100 hover:shadow-sm transition-all mb-6">
